...
![圖、筆者使用 Notepad++ 設定 UTF-8 格式的畫面](NotepadUtf8.png)
...
![圖、各種格式標記的網頁檢視畫面](HtmlFormat.png)
...
![圖、Header 1-6 的網頁檢視畫面](HtmlHeader1_6.png)
